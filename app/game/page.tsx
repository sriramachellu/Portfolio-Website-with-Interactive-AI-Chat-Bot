...
export default function GamePage() {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 24px 40px', overflow: 'hidden' }}>
            {/* Header */}
            <motion.div
            ...
            >
                ...
                <h1 style={{ fontSize: 'clamp(28px, 4vw, 36px)', fontWeight: 600, color: '#fff', letterSpacing: '-0.02em', marginBottom: 12 }}>
                    Interactive <span className="text-glass-tint">Inference</span> Engine
                </h1>
            ...
            <p className="text-micro" style={{ color: 'rgba(255,255,255,0.25)', marginTop: 12 }}>
                Move: Cursor / Touch · Execute: Space
            </p>
        </div>
    );
}
